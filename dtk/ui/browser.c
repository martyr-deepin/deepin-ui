...
static PyObject* dtk_browser_new(PyObject *self, PyObject *args);

static PyMethodDef dtk_browser_methods[] = {
     {"browser_new", (PyCFunction)dtk_browser_new, METH_VARARGS,
...
PyMODINIT_FUNC initdtk_browser(void) {
     PyObject *m;

     /* This is necessary step for Python binding, otherwise got sefault error */
     init_pygobject();
     
     m = Py_InitModule("dtk_browser", dtk_browser_methods);
